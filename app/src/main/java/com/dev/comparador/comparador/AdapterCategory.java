...
public class AdapterCategory extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView precio = (TextView) v.findViewById(R.id.lblPrecioP);
        precio.setText(dir.getPrecio());

        TextView tienda = (TextView) v.findViewById(R.id.lblTienda);
        tienda.setText(dir.getTienda());

        TextView direccion = (TextView) v.findViewById(R.id.lblDireccion);
